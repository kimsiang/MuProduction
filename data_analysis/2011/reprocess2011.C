...
//char *name = "lem11_his_0556.root"; // Ag plate
  char name[100];
  int run = 576;
  cout <<
...
//  cin >> run;
  ...
  for (run = 1418; run < 1465; run++) // SiO2-f 1418-1464, SiO2-Suprasil 1631-1653
    {

      if (run < 1000)
	{
	  sprintf (name, "../../musrfit/data/lem11_his_0%u.root", run);
	}
      if (run > 1000)
	{
	  sprintf (name, "../../musrfit/data/lem11_his_%u.root", run);
	}
	...
	<< endl;
      ...
      cout << "## Looking for RunInfo" << endl;
      TFolder *runinfo = (TFolder *) (f1->FindObjectAny ("RunInfo"));
      runinfo->GetListOfFolders ()->Print ();
	...
	(TObjArray *) (runinfo->FindObjectAny ("RunSummary"));
//runsummary->Dump();
      int t0;
      double Bfield;
      double Temp;
...
//post pile up rejection
      ...
      h1 = (TH1F *) histos->FindObjectAny ("hDecay00");
      h2 = (TH1F *) histos->FindObjectAny ("hDecay01");
      h3 = (TH1F *) histos->FindObjectAny ("hDecay02");
      h4 = (TH1F *) histos->FindObjectAny ("hDecay03");
      h5 = (TH1F *) histos->FindObjectAny ("hDecay04");
      h6 = (TH1F *) histos->FindObjectAny ("hDecay05");
      h7 = (TH1F *) histos->FindObjectAny ("hDecay06");
      h8 = (TH1F *) histos->FindObjectAny ("hDecay07");

      h21 = (TH1F *) histos->FindObjectAny ("hDecay20");
      h22 = (TH1F *) histos->FindObjectAny ("hDecay21");
      h23 = (TH1F *) histos->FindObjectAny ("hDecay22");
      h24 = (TH1F *) histos->FindObjectAny ("hDecay23");
      h25 = (TH1F *) histos->FindObjectAny ("hDecay24");
      h26 = (TH1F *) histos->FindObjectAny ("hDecay25");
      h27 = (TH1F *) histos->FindObjectAny ("hDecay26");
      h28 = (TH1F *) histos->FindObjectAny ("hDecay27");
...
//cout<<"time : "<<time<<", corrected time : "<<time/exp(-time/2.2)<<", bin content : "<<y<<endl;
      ...
      findbg1->SetParLimits(0,0,400);
      findbg2->SetParLimits(0,0,400);
      findbg3->SetParLimits(0,0,100);
      findbg4->SetParLimits(0,0,100);
      findbg5->SetParLimits(0,0,100);
      findbg6->SetParLimits(0,0,100);
      findbg7->SetParLimits(0,0,100);
      findbg8->SetParLimits(0,0,100);
      findbg9->SetParLimits(0,0,100);
      findbg10->SetParLimits(0,0,100);
