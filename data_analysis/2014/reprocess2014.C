...
//  cin >> run;
  ...
  for (run = 1076; run < 1096; run++) // SiO2-f 3427-3429, SiO2-f14 3430-3453, SiO2-b 3454-3480, Ag 3481-351-3453, SiO2-b 3454-3480, Ag 3481-3511
    {

      if (run < 1000)
	{
	  sprintf (name, "../../musrfit/data/lem14_his_0%u.root", run);
	}
      if (run > 1000)
	{
	  sprintf (name, "../../musrfit/data/lem14_his_%u.root", run);
	}
...
*/
      ...
      findbg1->SetParLimits(0,0,80);
      findbg2->SetParLimits(0,0,80);
      findbg3->SetParLimits(0,0,20);
      findbg4->SetParLimits(0,0,20);
      findbg5->SetParLimits(0,0,20);
      findbg6->SetParLimits(0,0,20);
      findbg7->SetParLimits(0,0,20);
      findbg8->SetParLimits(0,0,20);
      findbg9->SetParLimits(0,0,20);
      findbg10->SetParLimits(0,0,20);
